...
function clikedRowInfo(event) {
  ...
  restaurantName.textContent = `${restaurants[rowIndex].name}`;

  const restaurantAddress = document.createElement('p');
  restaurantAddress.textContent = `${restaurants[rowIndex].address}`;

  const postalCode = document.createElement('p');
  postalCode.textContent = `${restaurants[rowIndex].postalCode}`;

  const city = document.createElement('p');
  city.textContent = ` ${restaurants[rowIndex].city}`;

  const phoneNumber = document.createElement('p');
  phoneNumber.textContent = `${restaurants[rowIndex].phone}`;

  const company = document.createElement('p');
  company.textContent = `${restaurants[rowIndex].company}`;
